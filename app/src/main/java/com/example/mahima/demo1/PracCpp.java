...
public class PracCpp extends AppCompatActivity {
    ...
    {
        AlertDialog.Builder alertDialogBuilder=new AlertDialog.Builder(PracCpp.this);
        alertDialogBuilder.setMessage("Test OVER! Your Score is "+ mScore+"/10 points")
                ...
                .setPositiveButton("NEW TEST", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(getApplicationContext(),PracCpp.class));
                    }
                })
                ...
                .setNegativeButton("EXIT", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent=new Intent(PracCpp.this,Marks.class);
