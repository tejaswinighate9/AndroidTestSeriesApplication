...
public class PracPython extends AppCompatActivity {
    ...
    {
        AlertDialog.Builder alertDialogBuilder=new AlertDialog.Builder(PracPython.this);
        alertDialogBuilder.setMessage("Test OVER! Your Score is "+ mScore+"/10 points")
                ...
                .setPositiveButton("NEW TEST", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(getApplicationContext(),PracPython.class));
                    }
                })
                ...
                .setNegativeButton("EXIT", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent=new Intent(PracPython.this,Marks.class);
