...
public class FinalCpp extends AppCompatActivity {
    Button ans1,ans2,ans3,ans4,b1,b2,b3;
    TextView score,question,timer;

    private  QuestionsCpp mQuestions=new QuestionsCpp();
    ...
    {
        AlertDialog.Builder alertDialogBuilder=new AlertDialog.Builder(FinalCpp.this);
        alertDialogBuilder.setMessage("Test OVER! Your Score is "+ mScore+"/10 points")
                ...
                .setPositiveButton("NEW TEST", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(getApplicationContext(),FinalCpp.class));
                    }
                })
                ...
                .setNegativeButton("EXIT", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent=new Intent(FinalCpp.this,Marks.class);
