...
public class FinalSQL extends AppCompatActivity {
    Button ans1,ans2,ans3,ans4,b1,b2,b3;
    TextView score,question,timer;

    private  QuestionsSQL mQuestions=new QuestionsSQL();
    ...
    {
        AlertDialog.Builder alertDialogBuilder=new AlertDialog.Builder(FinalSQL.this);
        alertDialogBuilder.setMessage("Test OVER! Your Score is "+ mScore+"/10 points")
                ...
                .setPositiveButton("NEW TEST", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(getApplicationContext(),FinalSQL.class));
                    }
                })
                ...
                .setNegativeButton("EXIT", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent=new Intent(FinalSQL.this,Marks.class);
