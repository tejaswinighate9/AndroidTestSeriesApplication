...
public class PracC extends AppCompatActivity {
   ...
   /* private static final long START_TIME_IN_MILLIS = 60000;
    ...
    {
        AlertDialog.Builder alertDialogBuilder=new AlertDialog.Builder(PracC.this);
        alertDialogBuilder.setMessage("Test OVER! Your Score is "+ mScore+"/10 points")
                ...
                .setPositiveButton("NEW TEST", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        startActivity(new Intent(getApplicationContext(),PracC.class));
                    }
                })
                ...
                .setNegativeButton("EXIT", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent intent=new Intent(PracC.this,Marks.class);
